  ...
  if (error || !data?.user) {
    return (
      <div className="min-h-screen flex flex-col justify-center items-center px-4">
        <div className="max-w-md w-full bg-background-secondry rounded-xl border border-border p-8 text-center">
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center ">
      <div className="max-w-md w-full bg-background-secondry rounded-xl border border-border p-8 text-center">
        ...
        <Link
          href="/"
          className="inline-block px-6 py-3 bg-primary text-foreground rounded-full font-semibold hover:bg-primary/90 transition"
        >
          Go to Home
        </Link>
      </div>
